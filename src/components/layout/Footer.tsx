...
export function Footer() {
  return (
    <footer className="w-full border-t border-black dark:border-border bg-background mt-12">
      <div className="container mx-auto px-4 py-6 flex flex-col items-center space-y-4">
        <div className="flex space-x-6">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="text-foreground/90 dark:text-white">
        ...
        <p className="text-sm text-foreground/90 dark:text-gray-100">
